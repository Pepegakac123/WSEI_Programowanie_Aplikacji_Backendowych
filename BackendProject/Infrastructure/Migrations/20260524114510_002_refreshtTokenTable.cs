...
{
    /// <inheritdoc />
    public partial class _002_refreshtTokenTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Name = table.Column<string>(type: "TEXT", nullable: false),
                    FreeParkingDuration = table.Column<TimeSpan>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParkingTariff", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicensePlate = table.Column<string>(type: "TEXT", nullable: false),
                    DetectedBrand = table.Column<string>(type: "TEXT", nullable: false),
                    DetectedColor = table.Column<string>(type: "TEXT", nullable: false),
                    ImagePath = table.Column<string>(type: "TEXT", nullable: true),
                    CaptureType = table.Column<int>(type: "INTEGER", nullable: false),
                    CapturedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ParkingGateId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CameraCapture", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CameraCapture_ParkingGate_ParkingGateId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParkingFee = table.Column<decimal>(type: "TEXT", nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CameraCapture_ParkingGateId",
                table: "CameraCapture",
